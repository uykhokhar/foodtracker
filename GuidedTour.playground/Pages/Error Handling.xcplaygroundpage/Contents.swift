...
//How do you find what variables or functions are associated with Error
...
do {
    ...
    print(error)//is this turning the enum into a String?
}
...
do {
    ...
    print(String(describing: error) + " String conversion?")
}
